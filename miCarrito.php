...
<body>
    ...
    <?php  foreach($carrito as $item) { ?>
            ...
            <form action="itemCarrito.php" method="POST">
                ...
                <button button class="btn" name="borrar"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="32px" height="32px" viewBox="0 0 32 32" version="1.1">
